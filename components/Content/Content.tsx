      ...
      <div className="pt-12 lg:mt-0 lg:p-6 text-white">
        <div ref={aboutRef} className="border-b border-slate-600 pb-2">
          <p className="text-lg leading-8 pt-0 p-8">
            ...
            specializing in Javascript ES6. My scope of expertise revolves
            around Stack technology such as React, Redux, and Next.js, which
            have been augmenting my proficiency in developing dynamic, scalable,
            and user-friendly web applications using modern JavaScript
            frameworks and libraries. I am also passionate about staying up to
            date with the latest trends and advancements in technology.
          </p>
        </div>
        <div
          ref={expRef}
